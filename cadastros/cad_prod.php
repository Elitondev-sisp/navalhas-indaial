                ...
                <div class="row pt-2 pb-2">
                    <div class="col-sm-9">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Cadastros de Produtos</li>
                        </ol>
                    </div>
                </div>
                <!-- End Breadcrumb-->
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content animated fadeInUp">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id="form_prod" class="needs-validation" novalidate>
    ...
    <script>
        ...
        $("#form_prod").submit(function(e) {
            ...
            if (form.checkValidity() === false) {
                ...
                var urlpost = 'api_prod.php?modulo=produtos';
                var id = $('#edtID').val();
                if (id != '') {
                    urlpost = 'api_prod.php?modulo=produtos&id_produto=' + id;
                }
                var forme = $(this);
                $.ajax({
                    type: "POST",
        ...
        (function() {
            ...
            $('.btn-editar').on('click', function() {
                ...
                $('#titulo-modal').html('Editar Produto: ');
                $.get("api_prod.php?modulo=produtos&id_produto=" + $id_prod, function(data) {
            ...
            $('#modal-animation-14').on('hidden.bs.modal', function() {
                $('#titulo-modal').html('Novo Produto: ');
                $('#edtID').val('');
                $('#edtCodigo').val('');
                $('#edtDescricao').val('');
                $('#edtPreco').val(0);
